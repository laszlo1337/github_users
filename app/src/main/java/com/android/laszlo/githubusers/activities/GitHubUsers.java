...
public class GitHubUsers extends AppCompatActivity implements EndlessRecyclerOnScrollListener.OnLoadMoreListener {
    ...
    private void loadDataSinceId(int lastUserId) {
        Call<List<User>> call = apiService.getUsers(20, lastUserId);
